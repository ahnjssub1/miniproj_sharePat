...
<script type="text/javascript">
	function 그림파일읽어출력하기(이벤트) {
	    ...
	    var 파일리더 = new FileReader();
	  	  ...
	  	  var imgProfile=document.getElementById("share_profile");    	  
	  	  imgProfile.src=선택된그림파일관리객체.currentTarget.result;
	    };      
	    파일리더.readAsDataURL(선택된그림파일관리객체);
	    return ;
	}
	document.querySelector("#share_profileFile").addEventListener("change", 그림파일읽어출력하기, false);
</script>
<meta charset="UTF-8">
...
<h1>분양 등록</h1>
<div class="inform">
<form action="/shareNote" enctype="multipart/form-data"  method="post">
 제목<input type="text" name="share_title" /> <br>
 사진 <img id="share_profile" src="/img/no_image.jpg" width="200" height="300"/><br>
     <input type="file" name="share_profileFile" id="share_profileFile"/><br> 
 내용<textarea cols="25" rows="5" name="share_contents" ></textarea><br>
